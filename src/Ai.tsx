...
export default function Ai() {
  ...
  const S = {
    ...
    card: { background: "rgba(26,58,26,0.3)", border: "1px solid rgba(184,134,11,0.2)", borderRadius: "24px", padding: "20px", boxShadow: "0 10px 40px rgba(0,0,0,0.4)" },
    ...
    itiResult: { marginTop: "20px", padding: "16px", background: "rgba(26,58,26,0.2)", border: "1px solid rgba(184,134,11,0.2)", borderRadius: "16px", whiteSpace: "pre-wrap", lineHeight: "1.6" },
  };
      ...
      {activeTab === "plan" && (
        <div className="container" style={{ maxWidth: "1200px", padding: "20px" }}>
          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 items-start">
            ...
            <div className="w-full flex-1 grid gap-6">
